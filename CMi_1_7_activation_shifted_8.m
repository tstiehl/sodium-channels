...
%%
%% Simulation of CMi fiber where Nav1.7 acitvation is shifted by 8mV
%% This script generates Fig 11E
...
load("IC_CMi_shift_1_7_8.mat","IC")
shift_1_7 = 0.008; % shift of alpha_m and beta_m of Nav1.7 [V]

%check initial condition
i0=0; % injected current per area [uA/cm²] 
[T,Y] = ode23s(@HH_model_shifted_1_7,[0,100000000],IC);
figure()
plot(T,Y(:,1))
...
i0=15; % injected current per area [uA/cm²] 
[T_AP_15,Y_AP_15] = ode23s(@HH_model_shifted_1_7,[T_start,T_end],IC);


figure()
plot(T_AP_10,Y_AP_10(:,1),'k','LineWidth',2,'Color','#B7B7B7') % plot simulation for current injection of 10 uA/cm2
hold on
plot(T_AP_15,Y_AP_15(:,1),'k-','LineWidth',2) % plot simulation for current injection of 15 uA/cm2
...
set(gca,'FontSize',20)
xticks([0,25,50])
legend('10 \muA/cm^2', '15 \muA/cm^2')
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig11E.png','Resolution',300) 
