...
%%
%% Simulation of CMi fiber where Nav1.7 acitvation is shifted by 5mV
%% This script generates Fig 11D
...
load("IC_CMi_shift_1_7_5.mat","IC")
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig11D.png','Resolution',300) 
