...
%%
%% Simulation of Adelta fiber with 5-fold increased expression of Nav1.7
%% This script generates Fig 12A
...
%% simulation
i0 = 1.75; % injected current per area [uA/cm²] 
...
ylabel ('U [mV]')
set(gca,'FontSize',20)
legend('1.75 \muA/cm^2')
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig12A.png','Resolution',300) 
