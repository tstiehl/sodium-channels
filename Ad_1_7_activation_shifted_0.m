...
%%
%% Simulation of Adelta fiber with different current injections
%% This script generates Fig 12C
...
[T_AP_8,Y_AP_8] = ode23s(@HH_model,[T_start,T_end],IC);
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig12C.png','Resolution',300) 
