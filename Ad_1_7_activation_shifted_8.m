...
%%
%% Simulation of Adelta fiber where activation of Nav1.7 is shifted by 8mV
%% This script generates Fig 12E
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig12E.png','Resolution',300) 
