...
%% Phil Alexander Köster, Enrico Leipoldc, Jenny Tigerholm, Anna Maxion, Barbara Namer, Thomas Stiehl, Angelika Lampert
%%
%% Simulation of CMi fiber with current injection of 40uA/cm² and with individual Nav subtypes removed during AP
%% This script generates SFig 4A and SFig 6B
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS4_A_upper_left2.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS4_A_middle_left.png','Resolution',300) 
...
grid on
pbaspect([1 1 1]) 
exportgraphics(gca,'FigS4_A_middle_right.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS4_A_upper_right.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS4_A_lower_left.png','Resolution',300) 
...
pbaspect([1 1 1])
exportgraphics(gca,'FigS6_B.png','Resolution',300) 