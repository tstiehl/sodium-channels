...
beta_h_1_9 = @(x)max(0.01, chi(beta_h_1_9_par,x+0.007)); % beta_h for Nav 1.9, used in equation (6), the cutoff 0.01 avoids beta_h_1_9 to be zero within the physiological range of membrane potentials. 
...
% Nav1.7
alpha_m_1_7 = @(x)max(0, chi(alpha_m_1_7_par,x)); % alpha_m for Nav 1.7, used in equation (7)
beta_m_1_7 = @(x)max(0, chi(beta_m_1_7_par,x));  % beta_m for Nav 1.7, used in equation (7)
...
% conductances are calculated specified in equation (3)
