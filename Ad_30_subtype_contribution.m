...
%%
%% Simulation of Adelta fiber with current injection of 30uA/cm² and with individual Nav subtypes removed during AP
%% This script generates Fig 10A and SFig 6C
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_A_upper_left2.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_A_middle_left.png','Resolution',300) 
...
grid on
pbaspect([1 1 1]) 
exportgraphics(gca,'Fig10_A_middle_right.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_A_upper_right.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_A_lower_left.png','Resolution',300) 
...
pbaspect([1 1 1])
exportgraphics(gca,'FigS6_C.png','Resolution',300) 