...
%%
%% Simulation of CMi fiber with different current injections
%% This script generates Fig 11C
...
[T_AP_10,Y_AP_10] = ode23s(@HH_model,[T_start,T_end],IC);
i0=15; % injected current per area [uA/cm²] 
[T_AP_15,Y_AP_15] = ode23s(@HH_model,[T_start,T_end],IC);
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig11C.png','Resolution',300) 
