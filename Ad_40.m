...
%%
%% Simulation of Adelta fiber with current injection of 40uA/cm²
%% This script generates SFig 5B, SFig 5C, upper left panel of SFig 5A
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_A_upper_left.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_B_upper.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_C_upper.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_B_middle.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_C_middle.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_B_lower.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'FigS5_C_lower.png','Resolution',300) 
