...
%%
%% Simulation of Adelta fiber with current injection of 30uA/cm²
%% This script generates Fig 10B, Fig 10C, upper left panel of Fig 10A, SFig 8C and SFig 8D
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_A_upper_left.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_B_upper.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_C_upper.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_B_middle.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_C_middle.png','Resolution',300) 
...
xline(2,'--k')
hold on
plot(T_AP, AP_scaled*0.95+0.05, '-k','LineWidth',2) % overlay action potential shape, rescaled to fit y-axis range
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_B_lower.png','Resolution',300) 
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig10_C_lower.png','Resolution',300) 
...
plot(T_AP, AP_scaled*100,'--k') % overlayed scaled action potential
grid on
xlim([0,10])
set(gca,'FontSize',15)
xlabel('time [ms]')
...
exportgraphics(gca,'FigS8_C.png','Resolution',300) 
...
plot(T_AP, AP_scaled*1,'--k') % overlay scaled action potential
grid on
set(gca,'FontSize',18)
xlim([0,10])
xlabel('time [ms]')
