...
%%
%% Simulation of Adelta fiber with 8-fold increased expression of Nav1.8
%% This script generates Fig 12B
...
gNa_max_1_8 = f_1_8*gNa_max*8; % increase Nav1.8 by factor 8 compared to control
...
grid on
pbaspect([1 1 1])
exportgraphics(gca,'Fig12B.png','Resolution',300) 
