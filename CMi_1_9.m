...
%%
%% Simulation of CMi fiber with different expression levels ov Nav1.9 (current injection 30uA/cm²)
%% This script generates SFig 7
...
% load resting state of CMi fiber 
load('IC_CMi.mat')

% check initial condition
i0=0;
[T_AP,Y_AP] = ode23s(@HH_model,[0,1000],IC);
figure()
plot(T_AP,Y_AP(:,1))



%% Control scenario, Nav1.9 expression unchanged
%% simulation
i0=30; % injected current per area [uA/cm²] 
[T_AP_0,Y_AP_0] = ode23s(@HH_model,[T_start,T_end],IC);

%% Nav1.9 reduced by 50%
% set expression levels of Nav subtypes (taken from doi: 10.1126/scitranslmed.abj8186, rounded to two digits)
expr_1_1 = 0.03; % expression leven of Nav1.1 in CMi
expr_1_2 = 0.07; % expression leven of Nav1.2 in CMi
expr_1_3 = 0.01; % expression leven of Nav1.3 in CMi
...
expr_1_7 = 2.31; % expression leven of Nav1.7 in CMi
expr_1_8 = 0.95; % expression leven of Nav1.8 in CMi
expr_1_9 = 2.64 * 0.5; % expression leven of Nav1.9 in CMi, reduced by 50% compared to control
...
% Sodium channel conductance per unit area [mS/cm^2] 
gNa_max_1_9 = f_1_9*gNa_max; % Nav1.9
gNa_max_1_8 = f_1_8*gNa_max; % Nav1.8
gNa_max_1_7 = f_1_7*gNa_max; % Nav1.7 
gNa_max_1_6 = f_1_6*gNa_max; % Nav1.6
...
% load resting state of CMi fiber with Nav1.9 conductivity reduced by 50%
load('IC_CMi_1_9_50.mat')
...
% simulation
i0=30; % injected current per area [uA/cm²] 
[T_AP_50,Y_AP_50] = ode23s(@HH_model,[T_start,T_end],IC);


%% Nav1.9 reduced by 75%
% set expression levels of Nav subtypes (taken from doi: 10.1126/scitranslmed.abj8186, rounded to two digits)
expr_1_1 = 0.03; % expression leven of Nav1.1 in CMi
expr_1_2 = 0.07; % expression leven of Nav1.2 in CMi
expr_1_3 = 0.01; % expression leven of Nav1.3 in CMi
...
expr_1_7 = 2.31; % expression leven of Nav1.7 in CMi
expr_1_8 = 0.95; % expression leven of Nav1.8 in CMi
expr_1_9 = 2.64 * 0.25; % expression leven of Nav1.9 in CMi, reduced by 75% compared to control
...
% load resting state of CMi fiber with Nav1.9 conductivity reduced by 75%
load('IC_CMi_1_9_75.mat')
...
% simulation
i0=30;
[T_AP_75,Y_AP_75] = ode23s(@HH_model,[T_start,20],IC);
...
expr_1_7 = 2.31; % expression leven of Nav1.7 in CMi
expr_1_8 = 0.95; % expression leven of Nav1.8 in CMi
expr_1_9 = 2.64 * 0; % no Nav1.9 conductivity
...
% simulation
i0=30;
[T_AP_100,Y_AP_100] = ode23s(@HH_model,[T_start,20],IC);

figure()
plot(T_AP_0,Y_AP_0(:,1),'k-','LineWidth',2)
hold on
plot(T_AP_50,Y_AP_50(:,1),'-','LineWidth',2)
plot(T_AP_75,Y_AP_75(:,1),'-g','LineWidth',2)
plot(T_AP_100,Y_AP_100(:,1),'-b','LineWidth',2)
...
set(gca,'FontSize',14)
grid on
legend('control', 'Nav1.9 reduced by 50%', 'Nav1.9 reduced by 75%', 'No Nav1.9')
title('CMi: current injection 30 \muA/cm^2')
pbaspect([1 1 1])
exportgraphics(gca,'SFig7.png','Resolution',300) 
